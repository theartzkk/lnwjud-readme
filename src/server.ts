...
export function createServer(
  ...
  workspace: string,
  profile: ArtAgentServerProfile = 'local',
): McpServer {
  ...
  server.registerTool(
    ...
    async () => text({
      ...
      profile,
      safeMode: true,
      allowWrite: remoteReadOnly ? false : config.allowWrite,
      allowExec: remoteReadOnly ? false : config.allowExec,
      allowCodex: remoteReadOnly ? false : config.allowCodex,
    }),
  );
