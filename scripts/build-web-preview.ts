...
${dashboardGuardrails}`;
  await Promise.all([
    ...
    writeFile(join(OUTPUT, 'kruart-system.css'), kruartSystem, 'utf8'),
    ...
    copyFile(join(ROOT, 'web', 'kruart-hero-final.webp'), join(OUTPUT, 'kruart-hero-final.webp')),
    copyFile(join(ROOT, 'web', 'kruart-role-student-final.webp'), join(OUTPUT, 'kruart-role-student-final.webp')),
    copyFile(join(ROOT, 'web', 'kruart-role-teacher-final.webp'), join(OUTPUT, 'kruart-role-teacher-final.webp')),
    copyFile(join(ROOT, 'web', 'kruart-role-parent-final.webp'), join(OUTPUT, 'kruart-role-parent-final.webp')),
    copyFile(join(ROOT, 'web', 'kruart-role-staff-final.webp'), join(OUTPUT, 'kruart-role-staff-final.webp')),
    copyFile(join(ROOT, 'web', 'kruart-footer-final.webp'), join(OUTPUT, 'kruart-footer-final.webp')),
    copyFile(join(ROOT, 'web', 'kruart-logo-final.webp'), join(OUTPUT, 'kruart-logo-final.webp')),
    copyFile(join(ROOT, 'web', 'kruart-app-icon-512.png'), join(OUTPUT, 'kruart-app-icon-512.png')),
