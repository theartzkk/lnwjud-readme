...
async function main(): Promise<void> {
  ...
  const [index, styles, app, dashboardCss, ownerCenterCss, automationCss, finalHomeCss, dashboardJs, ownerCenterJs, automationJs, finalHomeJs, dashboardGuardrails, executionUx, toolRegistry, schoolTools, hubAdapter, controlAdapter, manifest, serviceWorker, databaseHtml, databaseCss, databaseJs, pdfLib, qrCode] = await Promise.all([
    asset('index.html'), asset('styles.css'), asset('app.js'), asset('dashboard.css'), asset('owner-center.css'), asset('automation-surface.css'), asset('final-home-polish.css'), asset('dashboard.js'), asset('owner-center.js'), asset('automation-surface.js'), asset('final-home-polish.js'), asset('dashboard-guardrails.js'), asset('execution-ux.js'), asset('tool-registry.js'), asset('school-tools.js'), asset('hub-read-adapter.js'), asset('control-plane-adapter.js'), asset('manifest.webmanifest'), asset('sw.js'), asset('database.html'), asset('database.css'), asset('database.js'),
