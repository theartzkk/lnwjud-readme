...
async function main(): Promise<void> {
  ...
  const [index, styles, app, dashboardCss, ownerCenterCss, dashboardJs, ownerCenterJs, dashboardGuardrails, executionUx, toolRegistry, schoolTools, hubAdapter, controlAdapter, manifest, serviceWorker, databaseHtml, databaseCss, databaseJs, pdfLib, qrCode] = await Promise.all([
    asset('index.html'), asset('styles.css'), asset('app.js'), asset('dashboard.css'), asset('owner-center.css'), asset('dashboard.js'), asset('owner-center.js'), asset('dashboard-guardrails.js'), asset('execution-ux.js'), asset('tool-registry.js'), asset('school-tools.js'), asset('hub-read-adapter.js'), asset('control-plane-adapter.js'), asset('manifest.webmanifest'), asset('sw.js'), asset('database.html'), asset('database.css'), asset('database.js'),
