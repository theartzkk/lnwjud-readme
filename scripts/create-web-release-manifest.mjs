...
const files = ['index.html', 'styles.css', 'awh-design-system.css', 'awh-light-system.css', 'responsive-layout.css', 'app.js', 'navigation.js', 'dashboard.css', 'dashboard.js', 'execution-ux.js', 'tool-registry.js', 'school-tools.js', 'vendor/pdf-lib.min.js', 'vendor/qrcode.js', 'hub-read-adapter.js', 'control-plane-adapter.js', 'database.html', 'database.css', 'database.js', 'infrastructure.html', 'infrastructure.css', 'infrastructure.js', 'hosting.html', 'hosting.css', 'hosting.js', 'trust.html', 'trust.css', 'trust.js', 'review.html', 'review.css', 'review.js', 'panel.html', 'panel.css', 'panel.js', 'manifest.webmanifest', 'sw.js', 'logo-256x256.png', 'web-config.json', 'data.json'];
