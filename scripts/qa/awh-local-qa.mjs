...
async function requiredFilesCheck() {
  ...
  const m12Required = [
    ...
    'hub/src/HubProjectVault.php', 'hub/src/HubProjectVaultService.php', 'hub/src/HubDurableExecutionService.php', 'hub/src/HubStorageGovernanceService.php', 'hub/src/HubStaffOperationsService.php',
...
async function phpHubCheck() {
  ...
  const m12Syntax = ['hub/src/HubCentralProjectAuthorityMigration.php', 'hub/src/HubProjectVault.php', 'hub/src/HubProjectVaultService.php', 'hub/src/HubDurableExecutionService.php', 'hub/src/HubStorageGovernanceService.php', 'hub/src/HubStaffOperationsService.php', 'hub/bin/migrate-central-project-authority.php', 'hub/bin/awh-native-executor.php', 'hub/tests/m12-central-project-authority.php', 'hub/tests/m12-production-parity.php', 'hub/tests/staff-operations.php', 'hub/tests/m17-product-verticals.php'];
  ...
  check('php-hub', verticals.code === 0 || verticals.code === 77 ? 'PASS' : 'FAIL', verticals.code === 0 || verticals.code === 77 ? 'PHP Hub migrations, canonical product vertical fixtures and integrity checks passed' : 'PHP M17 product vertical tests failed', started);
}
