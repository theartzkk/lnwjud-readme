...
async function requiredFilesCheck() {
  ...
  const required = [
    ...
    'hub/schema.sql', 'hub/migrations/001_m3e_enrollment.sql', 'hub/migrations/002_m3e2_enrollment_api.sql', 'hub/migrations/003_m4_control_plane.sql', 'hub/migrations/004_owner_auth.sql', 'hub/migrations/005_assistant_workstream.sql', 'hub/migrations/006_workspace_continuity.sql', 'hub/migrations/007_unified_workspace.sql', 'hub/migrations/008_final_product.sql', 'hub/migrations/009_founding_memory.sql', 'hub/public/index.php', 'hub/public/web-gateway.php', 'hub/public/enrollment.php', 'hub/public/control-plane.php', 'hub/src/HubReadModel.php', 'hub/src/HubReadRouter.php', 'hub/src/HubWebGateway.php', 'hub/src/HubEnrollmentService.php', 'hub/src/HubEnrollmentRouter.php', 'hub/src/HubSchemaMigration.php', 'hub/src/HubEnrollmentApiMigration.php', 'hub/src/HubControlPlaneMigration.php', 'hub/src/HubControlPlaneService.php', 'hub/src/HubControlPlaneRouter.php', 'hub/src/HubBrowserOriginPolicy.php', 'hub/src/HubControlPlaneProjectRegistration.php', 'hub/src/HubOwnerAuthMigration.php', 'hub/src/HubOwnerAuthService.php', 'hub/src/HubOwnerAuthRouter.php', 'hub/src/HubAssistantWorkstreamMigration.php', 'hub/src/HubWorkspaceContinuityMigration.php', 'hub/src/HubUnifiedWorkspaceMigration.php', 'hub/src/HubFinalProductMigration.php', 'hub/src/HubFoundingMemorySeed.php', 'hub/src/HubFoundingMemoryMigration.php', 'hub/src/HubFoundingMemoryService.php', 'hub/bin/index-project.php', 'hub/bin/migrate-m3e.php', 'hub/bin/migrate-m3e2.php', 'hub/bin/migrate-m4.php', 'hub/bin/migrate-owner-auth.php', 'hub/bin/migrate-assistant-workstream.php', 'hub/bin/migrate-workspace-continuity.php', 'hub/bin/migrate-unified-workspace.php', 'hub/bin/migrate-final-product.php', 'hub/bin/migrate-founding-memory.php', 'hub/bin/register-m4-projects.php', 'hub/bin/setup-owner-auth.php', 'hub/bin/verify-owner-auth-runtime.php', 'hub/tests/read-foundation.php', 'hub/tests/m3e-migration.php', 'hub/tests/m3e2-migration.php', 'hub/tests/enrollment-api.php', 'hub/tests/m4-control-plane.php', 'hub/tests/m4-zero-project-control.php', 'hub/tests/m4-project-registration.php', 'hub/tests/owner-auth.php', 'hub/tests/owner-auth-rollback.php', 'hub/tests/m6-assistant-workstream.php', 'hub/tests/m7-workspace-continuity.php', 'hub/tests/m8-unified-workspace.php', 'hub/tests/m9-final-product.php', 'hub/tests/m10-founding-memory.php', 'src/enrollment-client.ts', 'src/control-plane-worker-client.ts', 'src/credential-store.ts', 'scripts/deploy/provision-bootstrap-hash.mjs', 'scripts/deploy/bootstrap-owner.mjs', 'scripts/ops/activate-owner-auth.mjs', 'docs/M3E2_ENROLLMENT_API.md', 'docs/M3E_FINAL_PRODUCTION_VALIDATION.md', 'docs/M4_CONTROL_PLANE_ACTIVATION.md', 'docs/OWNER_AUTH_ACTIVATION.md', 'deploy/nginx/awh-preview.conf', 'deploy/nginx/awh-enrollment.conf', 'deploy/nginx/awh-control-plane.conf', 'deploy/nginx/render-control-plane-include.php', 'deploy/nginx/transform-owner-auth.php', 'deploy/php-fpm/awh-enrollment.pool.conf', 'deploy/awh-enrollment/deploy-enrollment.sh', 'deploy/awh-enrollment/preflight-production.sh', 'deploy/awh-enrollment/remote-deploy.sh', 'deploy/awh-enrollment/insert-nginx-include.php', 'deploy/awh-control-plane/deploy-control-plane.sh', 'deploy/awh-control-plane/remote-deploy-control-plane.sh', 'test/owner-auth-deployment.test.ts', 'test/founding-memory-deployment.test.ts',
  ];
  const missing = [];
...
async function phpHubCheck() {
  ...
  const syntaxFiles = ['hub/src/HubReadModel.php', 'hub/src/HubReadRouter.php', 'hub/src/HubWebGateway.php', 'hub/src/HubEnrollmentService.php', 'hub/src/HubEnrollmentRouter.php', 'hub/src/HubSchemaMigration.php', 'hub/src/HubEnrollmentApiMigration.php', 'hub/src/HubControlPlaneMigration.php', 'hub/src/HubControlPlaneService.php', 'hub/src/HubControlPlaneRouter.php', 'hub/src/HubControlPlaneProjectRegistration.php', 'hub/src/HubOwnerAuthMigration.php', 'hub/src/HubOwnerAuthService.php', 'hub/src/HubOwnerAuthRouter.php', 'hub/src/HubAssistantWorkstreamMigration.php', 'hub/src/HubWorkspaceContinuityMigration.php', 'hub/src/HubUnifiedWorkspaceMigration.php', 'hub/src/HubFinalProductMigration.php', 'hub/src/HubFoundingMemorySeed.php', 'hub/src/HubFoundingMemoryMigration.php', 'hub/src/HubFoundingMemoryService.php', 'hub/src/HubAttachmentStore.php', 'hub/src/HubNativeAgentService.php', 'hub/public/index.php', 'hub/public/web-gateway.php', 'hub/public/enrollment.php', 'hub/public/control-plane.php', 'hub/bin/index-project.php', 'hub/bin/migrate-m3e.php', 'hub/bin/migrate-m3e2.php', 'hub/bin/migrate-m4.php', 'hub/bin/migrate-owner-auth.php', 'hub/bin/migrate-assistant-workstream.php', 'hub/bin/migrate-workspace-continuity.php', 'hub/bin/migrate-unified-workspace.php', 'hub/bin/migrate-final-product.php', 'hub/bin/migrate-founding-memory.php', 'hub/bin/register-m4-projects.php', 'hub/bin/setup-owner-auth.php', 'hub/bin/verify-owner-auth-runtime.php', 'hub/tests/m4-zero-project-control.php', 'hub/tests/m6-assistant-workstream.php', 'hub/tests/m7-workspace-continuity.php', 'hub/tests/m8-unified-workspace.php', 'hub/tests/m9-final-product.php', 'hub/tests/m10-founding-memory.php', 'deploy/awh-enrollment/insert-nginx-include.php'];
  ...
  check('php-hub', foundingMemory.code === 0 || foundingMemory.code === 77 ? 'PASS' : 'FAIL', foundingMemory.code === 0 || foundingMemory.code === 77 ? 'PHP Hub, M3E/M4/M6/M7/M8/M9/M10 migration and workspace fixtures passed' : 'PHP M10 Founding Memory tests failed', started);
}
