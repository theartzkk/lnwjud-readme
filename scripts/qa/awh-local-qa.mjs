...
async function requiredFilesCheck() {
  ...
  const required = [
    ...
    'hub/schema.sql', 'hub/migrations/001_m3e_enrollment.sql', 'hub/migrations/002_m3e2_enrollment_api.sql', 'hub/migrations/003_m4_control_plane.sql', 'hub/migrations/004_owner_auth.sql', 'hub/public/index.php', 'hub/public/web-gateway.php', 'hub/public/enrollment.php', 'hub/public/control-plane.php', 'hub/src/HubReadModel.php', 'hub/src/HubReadRouter.php', 'hub/src/HubWebGateway.php', 'hub/src/HubEnrollmentService.php', 'hub/src/HubEnrollmentRouter.php', 'hub/src/HubSchemaMigration.php', 'hub/src/HubEnrollmentApiMigration.php', 'hub/src/HubControlPlaneMigration.php', 'hub/src/HubControlPlaneService.php', 'hub/src/HubControlPlaneRouter.php', 'hub/src/HubControlPlaneProjectRegistration.php', 'hub/src/HubOwnerAuthMigration.php', 'hub/src/HubOwnerAuthService.php', 'hub/src/HubOwnerAuthRouter.php', 'hub/bin/index-project.php', 'hub/bin/migrate-m3e.php', 'hub/bin/migrate-m3e2.php', 'hub/bin/migrate-m4.php', 'hub/bin/migrate-owner-auth.php', 'hub/bin/register-m4-projects.php', 'hub/bin/setup-owner-auth.php', 'hub/tests/read-foundation.php', 'hub/tests/m3e-migration.php', 'hub/tests/m3e2-migration.php', 'hub/tests/enrollment-api.php', 'hub/tests/m4-control-plane.php', 'hub/tests/m4-zero-project-control.php', 'hub/tests/m4-project-registration.php', 'hub/tests/owner-auth.php', 'hub/tests/owner-auth-rollback.php', 'src/enrollment-client.ts', 'src/control-plane-worker-client.ts', 'src/credential-store.ts', 'scripts/deploy/provision-bootstrap-hash.mjs', 'scripts/deploy/bootstrap-owner.mjs', 'scripts/ops/activate-owner-auth.mjs', 'docs/M3E2_ENROLLMENT_API.md', 'docs/M3E_FINAL_PRODUCTION_VALIDATION.md', 'docs/M4_CONTROL_PLANE_ACTIVATION.md', 'docs/OWNER_AUTH_ACTIVATION.md', 'deploy/nginx/awh-preview.conf', 'deploy/nginx/awh-enrollment.conf', 'deploy/nginx/awh-control-plane.conf', 'deploy/nginx/transform-owner-auth.php', 'deploy/php-fpm/awh-enrollment.pool.conf', 'deploy/awh-enrollment/deploy-enrollment.sh', 'deploy/awh-enrollment/preflight-production.sh', 'deploy/awh-enrollment/remote-deploy.sh', 'deploy/awh-enrollment/insert-nginx-include.php', 'deploy/awh-control-plane/deploy-control-plane.sh', 'deploy/awh-control-plane/remote-deploy-control-plane.sh', 'test/owner-auth-deployment.test.ts',
  ];
  const missing = [];
