...
async function runScript(script, timeoutMs = 15 * 60_000) {
  ...
  const testFiles = [
    ...
    'test/tunnel.test.ts', 'test/codex.test.ts', 'test/settings.test.ts', 'test/deployment-foundation.test.ts', 'test/qa-toolchain.test.ts', 'test/desktop.test.ts', 'test/desktop-projects.test.ts', 'test/credential-store.test.ts', 'test/enrollment-client.test.ts', 'test/bootstrap-provisioning.test.ts', 'test/bootstrap-orchestration.test.ts', 'test/autopilot.test.ts', 'test/first-run.test.ts', 'test/video.test.ts', 'test/release-identity.test.ts',
...
async function requiredFilesCheck() {
  ...
  const required = [
    ...
    'hub/schema.sql', 'hub/migrations/001_m3e_enrollment.sql', 'hub/migrations/002_m3e2_enrollment_api.sql', 'hub/public/index.php', 'hub/public/web-gateway.php', 'hub/public/enrollment.php', 'hub/src/HubReadModel.php', 'hub/src/HubReadRouter.php', 'hub/src/HubWebGateway.php', 'hub/src/HubEnrollmentService.php', 'hub/src/HubEnrollmentRouter.php', 'hub/src/HubSchemaMigration.php', 'hub/src/HubEnrollmentApiMigration.php', 'hub/bin/index-project.php', 'hub/bin/migrate-m3e.php', 'hub/bin/migrate-m3e2.php', 'hub/tests/read-foundation.php', 'hub/tests/m3e-migration.php', 'hub/tests/m3e2-migration.php', 'hub/tests/enrollment-api.php', 'src/enrollment-client.ts', 'src/credential-store.ts', 'scripts/deploy/provision-bootstrap-hash.mjs', 'scripts/deploy/bootstrap-owner.mjs', 'docs/M3E2_ENROLLMENT_API.md', 'docs/M3E_FINAL_PRODUCTION_VALIDATION.md', 'deploy/nginx/awh-preview.conf', 'deploy/nginx/awh-enrollment.conf', 'deploy/php-fpm/awh-enrollment.pool.conf', 'deploy/awh-enrollment/deploy-enrollment.sh', 'deploy/awh-enrollment/preflight-production.sh', 'deploy/awh-enrollment/remote-deploy.sh', 'deploy/awh-enrollment/insert-nginx-include.php',
  ];
  const missing = [];
