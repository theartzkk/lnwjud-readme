...
async function phpHubCheck() {
  ...
  check('php-hub', selfService.code === 0 || selfService.code === 77 ? 'PASS' : 'FAIL', selfService.code === 0 || selfService.code === 77 ? 'PHP Hub, M3E/M4/M6/M7/M8/M9/M10/M11 migration and workspace fixtures passed' : 'PHP M11 self-service tests failed', started);
}
