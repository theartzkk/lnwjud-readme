...
async function phpHubCheck() {
  ...
  const syntaxFiles = ['hub/src/HubReadModel.php', 'hub/src/HubReadRouter.php', 'hub/src/HubWebGateway.php', 'hub/src/HubEnrollmentService.php', 'hub/src/HubEnrollmentRouter.php', 'hub/src/HubSchemaMigration.php', 'hub/src/HubEnrollmentApiMigration.php', 'hub/src/HubControlPlaneMigration.php', 'hub/src/HubControlPlaneService.php', 'hub/src/HubControlPlaneRouter.php', 'hub/src/HubControlPlaneProjectRegistration.php', 'hub/src/HubOwnerAuthMigration.php', 'hub/src/HubOwnerAuthService.php', 'hub/src/HubOwnerAuthRouter.php', 'hub/src/HubAssistantWorkstreamMigration.php', 'hub/src/HubWorkspaceContinuityMigration.php', 'hub/src/HubUnifiedWorkspaceMigration.php', 'hub/src/HubFinalProductMigration.php', 'hub/src/HubAttachmentStore.php', 'hub/src/HubNativeAgentService.php', 'hub/public/index.php', 'hub/public/web-gateway.php', 'hub/public/enrollment.php', 'hub/public/control-plane.php', 'hub/bin/index-project.php', 'hub/bin/migrate-m3e.php', 'hub/bin/migrate-m3e2.php', 'hub/bin/migrate-m4.php', 'hub/bin/migrate-owner-auth.php', 'hub/bin/migrate-assistant-workstream.php', 'hub/bin/migrate-workspace-continuity.php', 'hub/bin/migrate-unified-workspace.php', 'hub/bin/migrate-final-product.php', 'hub/bin/register-m4-projects.php', 'hub/bin/setup-owner-auth.php', 'hub/bin/verify-owner-auth-runtime.php', 'hub/tests/m4-zero-project-control.php', 'hub/tests/m6-assistant-workstream.php', 'hub/tests/m7-workspace-continuity.php', 'hub/tests/m8-unified-workspace.php', 'hub/tests/m9-final-product.php', 'deploy/awh-enrollment/insert-nginx-include.php'];
  ...
  check('php-hub', finalProduct.code === 0 || finalProduct.code === 77 ? 'PASS' : 'FAIL', finalProduct.code === 0 || finalProduct.code === 77 ? 'PHP Hub, M3E/M4/M6/M7/M8/M9 migration and workspace fixtures passed' : 'PHP M9 final product tests failed', started);
}
