...
assert(hasEntry('ART_AI_WORKING_PROTOCOL.md'), 'packaged Art AI Working Constitution is missing');
...
const packagedProtocol = asar.extractFile(asarPath, 'ART_AI_WORKING_PROTOCOL.md').toString('utf8');
assert(/Art ↔ AI Working Constitution/.test(packagedProtocol) && /Version: 1\.0/.test(packagedProtocol), 'packaged owner working protocol identity is invalid');
