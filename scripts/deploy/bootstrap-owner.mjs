...
const DEPLOY_STAGES = new Set([
  ...
  'RELEASE_ACCESS_READY', 'RELEASE_STAGED', 'ENROLLMENT_COMPATIBILITY_VERIFIED', 'MIGRATION_FIRST_PASS', 'MIGRATION_IDEMPOTENT', 'FPM_CONFIGURED',
  'NGINX_CONFIGURED', 'SERVICE_RELOAD', 'M3D_REGRESSION', 'M3E_POST_SCHEMA_REGRESSION', 'ENROLLMENT_ROUTE',
]);
