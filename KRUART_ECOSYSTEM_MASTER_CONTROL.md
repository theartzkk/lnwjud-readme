...
|---|---|---|---|---|---|
| AWH / kruart.online | VERIFY | Main Orchestration Chat after reconciling any AWH closure lane | canonical main is 128a9413800843bc83a8681303bdb28fb378f1a3, merge of PR #159; source includes final-closure/chat-continuity/UI/BAY remote-authority changes | Last independently verified Production before PR #159 merge: m21-77573a7738ef, schema 21, SQLite integrity ok, FK clean, Nginx/PHP/native-executor/hosting-operator active. Do not assume 128a941 is deployed without fresh evidence. | Read PR #159/final lane handoff and live Production pointer before any AWH mutation or deploy |
