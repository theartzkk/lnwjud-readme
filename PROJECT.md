...
- M6 Assistant Workstream is the next **source-ready, not-yet-deployed** additive release. It advances only the shared Hub schema from v5 to v6 after an exact reviewed release lock; it preserves the owner, project, device, M3E and M4/M5 authorities and has no project-seeding step.
