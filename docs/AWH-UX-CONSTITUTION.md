...
**Open Art’s Workspace Hub → choose the project/system → enter AWH Workspace when you want AI work → type what you want → AWH answers or acts → show human progress → deliver an artifact → continue naturally.**

## Non-negotiable rules

1. The authenticated root is a Project Portfolio Hub. It shows the user’s systems/projects first and never drops directly into AWH Work. Inside **AWH Workspace**, the primary work surface remains Chat-first with a real composer, not a launcher that looks like an input.
...
7. Inside AWH Workspace, mobile has at most three primary destinations: **แชท · งานของฉัน · เครื่องมือ**. Root Portfolio navigation is separate and must not leak the AWH bottom nav. Settings/Owner controls belong behind profile/account surfaces.
...
18. Root Portfolio only shows information that helps the user choose or resume a project/system. AWH Workspace Home only shows information that helps the user start or resume AI work.
...
- Time to choose a system/project from Root Portfolio: < 5 seconds.
- Time to first prompt after entering AWH Workspace: < 5 seconds.
