...
candidate_qa_assert(is_string($source) && str_contains($source, "'schemaVersion' => 2") && str_contains($source, "'candidate' => \$qa") && str_contains($source, "HubVerificationIntelligence::plan(\$paths)"), 'candidate report must persist truthful QA evidence and shared risk intelligence');
