...
try {
    ...
    $reconciled = $vaults->expireStalePromotionApprovals($project, (string) $refreshed['activeRevisionId'], $now); m12_assert(($reconciled['expiredApprovals'] ?? 0) >= 1, 'canonical promotion expires stale revision-bound approvals');
