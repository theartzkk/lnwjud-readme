...
final class HubTrustPolicy
{
    ...
    public static function describe(string $action, array $context = []): array
    {
        ...
        return match ($action) {
            ...
            'hosting.site.delete', 'hosting.database.purge', 'hosting.backup.purge', 'system.core.release', 'system.learnlab.release', 'system.assessment.release' => self::policy(self::CRITICAL, true, true),
