...
final class HubDatabaseStudioService
{
    ...
    private function __construct(private readonly PDO $pdo, private readonly string $databasePath, private readonly string $migrationDir, private readonly ?string $fleetSnapshotPath = null) {}

    public static function openExisting(string $databasePath, ?string $migrationDir = null, ?string $fleetSnapshotPath = null): self
    {
        ...
        try {
            ...
            return new self($pdo, $databasePath, $migrationDir ?? dirname(__DIR__) . '/migrations', $fleetSnapshotPath);
