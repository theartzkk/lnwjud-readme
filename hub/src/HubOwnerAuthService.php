...
final class HubOwnerAuthService
{
    ...
    private static function assertAwhAccountPersonType(string $value): void { if(in_array($value,['PARENT','STUDENT'],true))throw new HubOwnerAuthException('School parent and student identity stays in BAY Parent Connect / LearnLab','IDENTITY_OWNED_BY_BAY'); }
