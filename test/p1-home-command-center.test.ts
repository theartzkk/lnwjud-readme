...
${await read('web/dashboard.css')}`;
  ...
  assert.match(css, /body\.work-active \.workspace-ecosystem-link,body\.work-active \.refresh-button\{display:none!important\}/);
  assert.doesNotMatch(css, /body\.work-active \.workspace-account[^}]*display:none!important/);
