...
FILES="$FILES deploy/nginx/awh-edge-hardening.conf deploy/nginx/awh-legacy-control-compat.conf deploy/fail2ban/awh-nginx-botsearch.local deploy/awh-control-plane/install-edge-hardening.sh"
