...
if test "$MODE" = dry-run; then
  ...
  if test "$CENTRAL_PROJECT_AUTHORITY" -eq 1; then
    echo "M12_ROLLBACK=restore-db-v11,pointer,web-pointer,nginx,service-health,m3d-m3e-m4-m7-m11-regression"
